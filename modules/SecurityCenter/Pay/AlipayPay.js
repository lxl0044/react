...
import { payForAlipay } from '../../Redux/Action/PayAction'
import { Icon,message } from 'antd';
import AlipayPayForCode from './AlipayPayForCode'
...
export default class WeChatPay extends React.Component {
    ...
    render() {
        ...
        const { show } = this.props.payAlipay
        ...
        return (
            <div className="weChatPay">
                ...
                {show ?  "" : <AlipayPayForCode { ...this.props }/>}
            </div>
        )
    }
}