...
const dataList = [{
    ...
    text11:"(4) 输入规则",
    text12:"价格上限：当前价格50%上限",
    text13:"价格下限：当前价格50%下限",
...
const dataList1 = [{
    ...
    text9:"买四:6.00 200",
    text10:"买五:5.00 200",
    text11:"如果这个时候我打出15.00买入500手,不考虑其它因素,最后的成交价是多少呢？股票成交原则：",
    text12:"1、如果以高于卖一的价格挂买单，以卖一的价格成交；如果卖一数量不够，依次用卖二、卖三补…… ",
    text13:"2、如果以低于买一的价格挂卖单，以买一的价格成交；如果买一的数量补够，依次用买二、买三补…… ",
    text14:"所以，你以高于卖五的价格挂单要买，则以10元成交200手、以11元成交200手、以12元成交100手。",
    text15:"如果此时有人以8元卖出350手，那么如何成交呢？首先买一9元的300手会完全成交，其次买二以8元成交50手，谁先挂单谁先成交。",
    text16: "(7) 如何撤单",
    text17:"可在买卖区域右侧个人委托列表中未成交委托中进行撤单操作。也可点击导航栏中进入委托管理页面撤单。",
}]
